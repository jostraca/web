...
export const GET: APIRoute = async ({ site }) => {
  ...
  const parts: string[] = [
    ...
    `> ${SITE_DESCRIPTION}`,
    "",
    "Every documentation page, concatenated, as synced from the generator",
    `repository. This site runs its own examples against \`jostraca\` ${JOSTRACA_VERSION};`,
    "the pages may describe a later release.",
